...
if ($stmt) {
    echo '<form method="POST" action="AdminSuppr.php">';
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '<td><input type="hidden" name="idproduit[]" value="' . $row["idproduit"] . '"><input class="boutton-suppr" type="submit" name="supprimer[' . $row["idproduit"] . ']" value="Supprimer"></td>';
        echo '</tr>';
    }
